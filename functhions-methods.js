const persona = [
    {nombre: "Ale", apellido: "Casandra", edad: 29},
    {nombre: "Juan", apellido: "Mendes", edad: 21},
    {nombre: "CArlo", apellido: "Carl", edad: 23},
    {nombre: "Perdo", apellido: "Louisa", edad: 27},
    {nombre: "Gabi", apellido: "Andrade", edad: 28},
    {nombre: "Milito", apellido: "Rose", edad: 21}
] 
...
// Forma 2
persona.forEach(function(index, nbomb)  {
    console.log(index, nbomb)
});

// Forma 3
persona.forEach((index, nbomb) => {
    console.log(index, nbomb)
});
